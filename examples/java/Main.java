...
public class Main {
    ...
    private static final String MARKET = "MX";
    private static final String EXCHANGE = "BMV";
    private static final String SYMBOL = "BMV:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"BMV:000040\",\"BMV:005930\"],\"replay\":\"last\"}";
