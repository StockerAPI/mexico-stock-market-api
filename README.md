...
Kun Data provides real-time market data for Mexico through a token-authenticated API stack designed for charting tools, watchlists, market overview pages, brokerage dashboards, and quant workflows.

This repository focuses on Mexico market coverage with support for BMV, BIVA.

## API Capabilities

- Real-time WebSocket market data for Mexico
...
This repository is designed to make Mexico market API coverage easier to discover and evaluate.

## Links

- Website: https://kun.pro/markets/mexico-stock-market-api
